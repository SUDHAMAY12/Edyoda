...
Original file is located at
    https://colab.research.google.com/drive/14VAcRqqaNWkmSgkP_KJVkiu6jgQiBtAK
"""
...
class Bakery:
    ...
    def admin_register(self):
        try:
            ...
            print(f"WELCOME TO {self.beak_name} BeAKRY\nWE ARE DELIGHTED TO HAVE YOU")
            print("ADMIN DETAILS: ")
...
try:
    def main():
        obj=Bakery("SUDHAMAY")
        print(f"!!######______Welcome To {obj.bake_name} Bakery______###### !!\n")
        print("\n\n!!WE ARE DELIGHTED TO HAVE YOU!!")
